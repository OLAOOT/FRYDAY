...
--
-- 테이블의 덤프 데이터 `likerecipe`
--

INSERT INTO `likerecipe` (`id_like`, `user_id`, `post_id`) VALUES
(1, 1, 1),
(3, 14, 32),
(4, 14, 49),
(5, 14, 45),
...
(48, '조개 술찜', 3, 0, 0, 6, '\\img4848484848', '바지락은 소금물에 해감해서 깨끗이 씻어주세요\r\n내열 그릇에 바지락을 넣고 물100ml, 맛술, 마늘, 고추, 소금, 후추를 뿌려주세요\r\n80도에서 5분간 돌려주세요\r\n바지락을 한 번 섞고 180도에서 5분 돌려주세요'),
(49, '모둠채소구이', 4, 0, 2, 3, NULL, '넣을 채소들을 손질해주세요\r\n허브솔트와 허브를 섞어주세요\r\n200도에서 10분간 돌려주세요\r\n뒤집어서 5분간 더 돌려주세요'),
...
(53, '에그아보카도', 7, 0, 0, 1, '\\img5353535353', '베이컨을 잘게 썰고 아보카도는 반으로 썰어주세요\r\n아보카도를 살짝 파내 계란이 들어갈수있는 공간을 만들어주세요\r\n아보카도안에 계란과 베이컨을 넣어주세요\r\n180도에서 15분 동안 돌려주세요'),
...
--
ALTER TABLE `likerecipe`
  MODIFY `id_like` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
